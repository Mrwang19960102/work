...
def get_css_svg_link(url):
    ...
    for css in css_link_list:
        if css.startswith('//s3plus.meituan.net/v1/mss_0a06a471f9514fc79c981b5466f56b91/'):
            css_link = 'https:' + css
            break
    svg_link = 'http://s3plus.meituan.net/v1/mss_0a06a471f9514fc79c981b5466f56b91/svgtextcss/719f323b0be12d7e39b9e144eb00d048.svg'
    print(css_link)
    return css_link, svg_link
...
def get_font_map_data(url):
    ...
    if css_link and svg_link:
        ...
        fonts_xy = get_comment_map(svg_link)
...
def commments_info(url):
    ...
    @return:
    '''
    font_map_df, res = get_font_map_data(url)
    if not font_map_df.empty and res:
